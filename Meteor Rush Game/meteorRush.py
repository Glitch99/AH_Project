...
icon = pygame.image.load("entities/icon.png") 
...
def makeMeteor(x,y):                   # Creates a meteor
...
def hyperSpace(spaceX,baseMult):
    ...
    if spaceX[0] <= -1000:                               # Resets the backgrounds should they go past a certain point, creating a
...
#************************************************************* Make Obstacles ******************************************************************************#
        ...
        if pygame.time.get_ticks() > timeTillNextObstacle and tutPassed == True:                          # Creates a new meteor if enough time has passed
            ...
            timeTillNextObstacle += (random.randint(500,1000))           # Increases the value of timeTillNextObstacle by a random integer
    ...
    while worldState == 4:
        ...
        highMessage = font.render(playerName + ", you got " + str(finalScore) + "pts!", 1, white) 
