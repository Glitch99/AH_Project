...
def nameGen():
    ...
    k2 = keyGen(False,2)
    k3 = keyGen(False,3)
    playerName = (str(k1) + str(k2) + str(k3))
    return playerName
        
def keyGen(done, section):
...
def selectName():
    ...
    if nameIsCorrect != True:
        confirmism = font.render("Click To Confirm, or Press Any Key to Re-Enter" ,3,white)
        screen.blit(confirmism, (350,350))
        for event in events:
